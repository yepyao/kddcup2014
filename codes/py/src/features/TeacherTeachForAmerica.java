...
public class TeacherTeachForAmerica {
	public static void main(String[] args) throws IOException{
		...
		while (s != null){
			...
			if (kind.get(splits.get(19)) == null){
				kind.put(splits.get(19), String.valueOf(kindNum));
				kindNum++;
			}
			price.put(splits.get(0), kind.get(splits.get(19)));
			s = in.readLine();
		}
		in.close();
