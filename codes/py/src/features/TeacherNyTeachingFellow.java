...
public class TeacherNyTeachingFellow {
	public static void main(String[] args) throws IOException{
		...
		while (s != null){
			...
			if (kind.get(splits.get(20)) == null){
				kind.put(splits.get(20), String.valueOf(kindNum));
				kindNum++;
			}
			price.put(splits.get(0), kind.get(splits.get(20)));
			s = in.readLine();
		}
		in.close();
