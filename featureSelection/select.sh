...
java -cp ../codes/yep/bin evaluation.MakeSubmission pred.txt ../test.txt submission.txt ../data/projectIDMapping > result/temp_$2

line=$(head -1 result/temp_$2)
read -a array <<<$line
echo ${array[1]} > result/result_$2